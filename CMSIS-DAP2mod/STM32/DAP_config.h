...
#define CPU_CLOCK               SystemCoreClock //100000000U      ///< Specifies the CPU Clock in Hz.
...
#define TIMESTAMP_CLOCK         SystemCoreClock//100000000U      ///< Timestamp clock in Hz (0 = timestamps not supported).
...
extern void LedConnectedOut(uint16_t bit);
extern void LedRunningOut(uint16_t bit);
